...
$routes->get('/masyarakat/deleted/(:segment)', 'MasyarakatController::deleted/$1');

$routes->get('/petugas','PetugasController::index');
$routes->add('/fpetugas','PetugasController::create');
$routes->add('petugas','PetugasController::save');
$routes->add('petugas/edit/(:segment)','PetugasController::edit/$1');
$routes->get('/petugas/deleted/(:segment)','PetugasController::delete/$1');

$routes->get('gettanggapan','TanggapanController:gettanggapan');
$routes->post('tanggapan','TanggapanController:simpan');

$routes->get('pengaduan','PengaduanController::index');
$routes->post('/tambahpengaduan','PengaduanController::save');
$routes->get('/pengaduan/deleted/(:segment)','PengaduanController::deleted/$1');
$routes->get('/profil','LoginController::profil');
$routes->post('editp/edit/(:segment)','LoginController::editprofil/$1');
